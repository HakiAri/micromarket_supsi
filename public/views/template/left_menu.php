<div class="left-side sticky-left-side">
    ...
    <div class="left-side-inner">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <?php if($_SESSION['rol']==1 || $_SESSION['rol']==0): ?>
            <li class="menu-list <?php echo $menu_a['ventas']; ?>"><a href="<?php echo ROOT_CONTROLLER; ?>ventas/"><i class="fa fa-shopping-cart"></i><span>Ventas Supsi</span></a>
                <ul class="sub-menu-list">
                    <li class="<?php echo $menu_a['ventas_a']; ?>"><a href="<?php echo ROOT_CONTROLLER; ?>ventas/"> Realizar Venta</a></li>
                    <li class="<?php echo $menu_a['ventas_b']; ?>"><a href="<?php echo ROOT_CONTROLLER; ?>ventas/consultar_venta.php">Consultar Ventas</a></li>
                </ul>
            </li>
            <?php endif; ?>
