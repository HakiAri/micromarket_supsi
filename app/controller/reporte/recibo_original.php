...
$printer->text("------------------------------------------------". "\n");
$printer->text("NroRecibo: ".$nroRecibo."      Fecha: ".date("Y-m-d H:i:s")."\n");
//$printer->text("NroRecibo: ".$nroRecibo."      Fecha: ".getdate()."\n");
#La fecha también
...
$printera->text("------------------------------------------------". "\n");
$printera->text("NroRecibo: ".$nroRecibo."      Fecha: ".date("Y-m-d H:i:s")."\n");
#La fecha también
